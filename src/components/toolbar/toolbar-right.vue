<template>
  <div class="icon-box">
    ...
    <template v-else>
      ...
      <span @click="print" v-tooltip.top-center="$t('toolbar.right.print')"
        ><i class="iconfont icon-print"></i
      ></span>
      <span @click="help" v-tooltip.top-center="$t('toolbar.right.help')"
        ><i class="iconfont icon-help"></i
      ></span>
      <slot name="toolbarRightAfter"></slot>

      <div v-show="helpDocShow" @click="help" class="help-pop markdown-body">
